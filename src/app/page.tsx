  ...
  return (
    <div className="flex flex-col gap-5 items-center justify-center">
      ...
      <p className="text-lg text-center">
        If you don&apos;t write stories, who will tell your grandchildren that
        you once had a life that wasn&apos;t just about complaining about your
        knees?
      </p>
      <button className="flex justify-center items-center px-4 py-2 rounded-full bg-green-500">
        <Link href="/story-canvas" className="text-lg font-semibold">
          Write a Story
        </Link>
      </button>
    </div>
